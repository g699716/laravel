	...
	<form method="post" action="update" enctype="multipart/form-data">
		<table border="0" align="center">
			...
			<tr>
				<td>性别:</td>
				<td>
					<input type="radio" name="sex" value="1" @if($userData['sex']==1) checked @endif >男
					<input type="radio" name="sex" value="2" @if($userData['sex']==2) checked @endif >女
				</td>
			</tr>
			<tr>
				<td>原头像：</td>
				<td>
					<img src="http://uploads.laravel.com/{{$userData['u_img']}}" width="50">
				</td>
			</tr>
			<tr>
				<td>更换头像:</td>
				...
				$(document).on('click','#btn',function(){
					...
					if(obj.username==''){
						...
						$.ajax({
							...
							method:'post',
							async:false,
							data:{id:obj.u_id,username:obj.username,_token:obj._token},
